<template>
  <div>
    <div class="container">
      <div class="row">
        <div class="col-md-8 left" v-for="i in list" i="i.id" :key="i.id">
            ...
            <div class="lph-list">
              ...
              <div class=" col-md-11 lph-list-text">
                ...
                <div>
                  ...
                  <span class="pp" v-text="i.liulan"></span>
                  <span class="pp"><img src="../assets/images/pinglun.png" alt=""></span>
                  <span class="pp" v-text="i.pinglun"></span>
  ...
  export default {
    ...
    methods: {
      ...
      getData: function () {
        var vm = this;
        var a = this.id
        axios.get(' http://127.0.0.1:8000/petshow/showdetail/' + a + '/')
      ...
      getComments: function () {
        var vm = this;
        // var pet_id=this.id
        axios.get('http://localhost:8000/petshow/showcomments/' + this.id + '/')
          .then(function (response) {
            // console.log(response.data)
            vm.arr = response.data.name
            console.log(vm.arr)
          })
          .catch(function (error) {
            // vm.answer = 'Error! Could not reach the API. ' + error
      ...
      comments: function () {
        ...
        console.log(data)
        if(this.content){
          axios.post('http://127.0.0.1:8000/petshow/comments/', data)
            .then(function (res) {
